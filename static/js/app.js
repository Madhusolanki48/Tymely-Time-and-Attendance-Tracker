...
function showAlert(message, type = 'info') {
    ...
    alertContainer.className = `alert-floating alert alert-${type} bg-${getAlertColor(type)}-100 border border-${getAlertColor(type)}-400 text-${getAlertColor(type)}-700 px-4 py-3 rounded relative`;
